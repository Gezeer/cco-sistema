...
assert.match(fonteKpi,/maximoVisualComparativo=maiorValor\*1\.25/,"eixo deve reservar 25% de folga visual");
...
assert.match(html,/js\/cco-graficos-3d\.js\?v=20260805-kpi-rotulos-mensais-v1/);
