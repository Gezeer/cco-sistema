...
for(const html of["index.html","kpi.html","execucao.html","historico.html","dados.html","analytics-ai.html"]){const versao=html==="index.html"?"20260811-painel-catalogo-fallback-leve-v4":"20260807-performance-boot-v2";assert.match(ler(html),new RegExp(`services/cache\\.js\\?v=${versao}`));}
