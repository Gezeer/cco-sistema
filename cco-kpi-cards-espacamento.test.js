...
assert.match(css,/\.kpi-producao-mensal-card[\s\S]*grid-template-rows: auto 360px[\s\S]*row-gap: 16px[\s\S]*height: 490px !important/);
assert.match(css,/\.kpi-producao-mensal-grafico[\s\S]*height: 360px !important[\s\S]*padding-bottom: 0/);
